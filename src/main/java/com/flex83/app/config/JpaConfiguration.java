package com.flex83.app.config;

import com.flex83.app.entities.TenantDatabaseConfig;
import com.flex83.app.props.MysqlProperties;
...
import static com.flex83.app.constant.ApplicationConstants.*;


@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {"com.flex83.app.repository"})
public class JpaConfiguration {
    ...
    private void createDatabaseIfNotExists() {
        try (Connection connection = DriverManager.getConnection(mysqlProperties.getHibernateMtUrl().split(DATABASE)[0], mysqlProperties.getHibernateConnectionUsername(), mysqlProperties.getHibernateConnectionPassword());
            ...
            int result = statement.executeUpdate("CREATE DATABASE " + FLEX83_DEVICES_DATABASE);
            if (result > 0) {
    ...
    public DataSource getDataSource() {
        ...
        hikariDataSource.setJdbcUrl(mysqlProperties.getHibernateMtUrl().split(DATABASE)[0] + FLEX83_DEVICES_DATABASE);
        hikariDataSource.setPoolName(FLEX83_DEVICES_DATABASE + " connection-pool");
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() {
        ...
        em.setPersistenceUnitName(FLEX83_DEVICES_DATABASE + " persistence-unit");
